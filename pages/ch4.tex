...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{CCCC}
      ...
      \midrule
      GAS/SAS & 7.31K & 130.37M & 72.80\\
      SG & 7.36K & 133.04M & \textbf{73.61}\\
      Ghost & \textbf{7.27K} & \textbf{129.93M} & 72.03\\
      \midrule
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{CCCC}
      ...
      SCoT-After & \textbf{77.66} & \textbf{0.70} & \textbf{11.33} \\
      \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[ht]
    ...
    %   \caption{子表a}
      ...
      \begin{tabularx}{\textwidth}{CCCCCC}
        ...
        \midrule 
        HA-FuseNet  & 67.50 & 67.50 & 89.23 & 75.39 & 82.50 \\
        \bottomrule
      \end{tabularx}
    \end{subtable}
    \begin{subtable}[ht]{\textwidth}
    ...
    %   \caption{子表b}
      ...
      \begin{tabularx}{\textwidth}{CCCCCCC}
        ...
        \midrule 
        HA-FuseNet  & 82.50 & 80.00 & 72.14 & 71.67 & 76.49\\
        \bottomrule
      \end{tabularx}
    \end{subtable}
