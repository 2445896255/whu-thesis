...
\begin{table}[ht]
    ...
    %   \caption{子表b}
      ...
      \begin{tabularx}{\textwidth}{CCCCCCC}
        ...
        \midrule
        ShallowConvNet\cite{schirrmeister2017deep} & 57.29 & 86.81 & 89.93 & 85.42 & 78.52\\
        ...
        EEGResNet\cite{HBM:HBM23730} & 42.36 & 54.51 & 61.11 & 64.93 & 54.69 \\
        EEGInception\cite{zhang2021eeg} & 52.43 & 75.00 & 85.41 & 73.61 & 70.72 \\
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{CCC}
      ...
      Models & Kappa & SD \\
      \midrule
      ShallowConvNet\cite{schirrmeister2017deep} & 0.71 & 12.15\\
      ...
      EEGInception\cite{zhang2021eeg} & 0.62 & 10.74 \\
...
\begin{table}[ht]
    ...
    %   \caption{子表a}
      ...
      \begin{tabularx}{\textwidth}{CCCCCC}
        ...
        Models & 1 & 2 & 3 & 4 & 5\\
        \midrule
        ShallowConvNet\cite{schirrmeister2017deep} & 94.34 & 96.69 & 66.20 & 89.55 & 76.39 \\
        DeepConvNet\cite{schirrmeister2017deep} & 91.11 & 86.85 & 62.37 & 82.58 & 69.18 \\
        EEGNet\cite{lawhern2018eegnet} & 94.95 & 85.80 & 67.77 & 87.63 & 61.63 \\
        EEGResNet\cite{HBM:HBM23730} & 76.22 & 77.61 & 53.05 & 61.85 & 49.39 \\
        EEGInception\cite{zhang2021eeg} & 91.20 & 92.86 & 70.30 & 82.93 & 77.52 \\
        EEGConformer\cite{song2022eeg} & 85.98 & 52.27 & 47.82 & 25.61 & 58.25 \\
        LMDA-Net\cite{miao2023lmda} & 91.99 & 93.21 & 69.16 & 86.41 & 70.31 \\
        \midrule 
        HA-FuseNet \\
        \bottomrule
      \end{tabularx}
    ...
    %   \caption{子表b}
      ...
      \begin{tabularx}{\textwidth}{CCCCCCC}
        ...
        Models & 6 & 7 & 8 & 9 & Average \\
        \midrule
        ShallowConvNet\cite{schirrmeister2017deep} & 62.24 & 90.94 & 84.54 & 89.72 & 83.40 \\
        DeepConvNet\cite{schirrmeister2017deep} & 59.38 & 85.80 & 73.15 & 82.58 & 77.00 \\
        EEGNet\cite{lawhern2018eegnet} & 46.09 & 83.71 & 66.25 & 77.61 & 74.60 \\
        EEGResNet\cite{HBM:HBM23730} & 44.44 & 75.35 & 65.37 & 77.88 & 64.57 \\
        EEGInception\cite{zhang2021eeg} & 60.85 & 83.97 & 78.45 & 89.11 & 80.80 \\
        EEGConformer\cite{song2022eeg} & 26.65 & 27.00 & 25.27 & 80.05 & 47.65 \\
        LMDA-Net\cite{miao2023lmda} & 60.24 & 83.28 & 81.18 & 88.15 & 80.44 \\
        \midrule 
        HA-FuseNet \\
        \bottomrule
      \end{tabularx}
...
\begin{table}[ht]
    ...
    \begin{tabularx}{\textwidth}{CCC}
      ...
      Models & Kappa & SD \\
      \midrule
      ShallowConvNet\cite{schirrmeister2017deep} & 0.77 & 11.67 \\
      ...
      EEGInception\cite{zhang2021eeg} & 0.74 & 9.79 \\
